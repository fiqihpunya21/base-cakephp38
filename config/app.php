...
return [
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', 'cake42f211b5a2c9a8df956358be42a82b2e3b11d13f0f98922f6612f7e4fed2fd92learn'),
    ],
    ...
    'EmailTransport' => [
        ...
        'gmail' => [
            ...
            'port' => 465,
            'timeout' => 60,
            'username' => 'noreply-auto@sbm-itb.ac.id',
            'password' => 'b4510laxvzf',
            //'client' => null,
            // 'tls' => true,
            //'url' => env('EMAIL_TRANSPORT_DEFAULT_URL', null),
        ],
    ...
    'Email' => [
        'default' => [
            'transport' => 'gmail',
            'from' => 'noreply-auto@sbm-itb.ac.id',
            //'charset' => 'utf-8',
            //'headerCharset' => 'utf-8',
        ],
    ],
