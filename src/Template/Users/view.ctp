...
<div class="users view large-9 medium-8 columns content">
    ...
    <table class="vertical-table">
        ...
        <tr>
            <th scope="row"><?= __('Mail Password') ?></th>
            <td><?= h($user->mail_password) ?></td>
        </tr>
        <tr>
            <th scope="row"><?= __('Social') ?></th>
            <td><?= $user->has('social') ? $this->Html->link($user->social->id, ['controller' => 'Socials', 'action' => 'view', $user->social->id]) : '' ?></td>
        </tr>
        <tr>
