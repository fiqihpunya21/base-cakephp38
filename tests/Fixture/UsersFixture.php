...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'mail_password' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'avatar' => ['type' => 'string', 'length' => 100, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'active' => 'L',
                'created' => '2020-02-26 02:38:27',
                'modified' => '2020-02-26 02:38:27'
            ],
        ];
        parent::init();
    }
